...
## <span style="color:gray; font-family:Microsoft JhengHei;">**14.1**</span> **Limitation of linear model**

Some limitations of linear models:

1. Out of the range of possible y
2. The residuals-vs-predicted plot indicates two parallel lines, which is very unlikely if a linear model is appropriate.
...
## <span style="color:gray; font-family:Microsoft JhengHei;">**14.2**</span> **Binary logistic regression**

### <span style="color:gray; font-family:Microsoft JhengHei;">**14.2.1**</span> **Concept**

**(Binary) Logistic regression:**<br>
Use a <mark>logistic function</mark> to model a <mark>binary dependent variable</mark> (1/0, yes/no, true/false, win/lose, male/female) against one or multiple qualitative variables.
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**14.2.2**</span> **Example**

#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.2.2.1**</span> **Fit the model**
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.2.2.2**</span> **Assess the model**
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.2.2.3**</span> **Visualization**
...
## <span style="color:gray; font-family:Microsoft JhengHei;">**14.3**</span> **Multinomial and ordinal logistic regression**

### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.1**</span> **Concept**

**Multinomial logistic regression:**<br>
Use a logistic function to model a nominal variable with multiple levels against one or multiple qualitative variables.<br>
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.1.1**</span> **As a Model for Odds**
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.1.2**</span> **As a Model of Probabilities**

$${P(Y{i}=j|X{i})}=\frac{exp[\alpha_{j}+\beta_{j}x_{i}]}{\sum_{h=1}^{J}exp[\alpha_{h}+\beta_{h}x_{i}]},\quad where \,\, j = 1,...,J$$

### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2**</span> **Example**

#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2.1**</span> **Prepare the data**
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2.2**</span> **Fit the model**

- Only two species displayed: <span style="color:red">setosa as the baseline level</span>
```{r}
library(nnet)
model <- multinom(Species ~., data = train.data)
summary(model)
```
$$O_{ve}=\frac{P(Y_i=versicolor)}{P(Y_i=setosa)} = exp(48.28722 - 24.64201L_s - 24.27893W_s + 47.2458L_p + 3.130761W_p)$$
$$O_{vi} = \frac{P(Y_i=virginica)}{P(Y_i=setosa)} = exp(-83.41388 - 58.94158L_s - 60.89885W_s + 117.6548L_p + 65.130414W_p)$$

#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2.3**</span> **Validate the model**
...
- H0: $\beta = 0$ (the Wald statistic is an approximate standard normal distribution)
$$z_{score} =\frac{β}{s_e}$$
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2.4**</span> **Simply the model**
...
#### <span style="color:gray; font-family:Microsoft JhengHei;">**14.3.2.5**</span> **Result**
...
## <span style="color:gray; font-family:Microsoft JhengHei;">**15.1**</span> **Concept**

### <span style="color:gray; font-family:Microsoft JhengHei;">**15.1.1**</span> **Definition**
**Poisson distribution:**<br>
<mark>A discrete probability distribution.</mark> The probability of occurrence of an event in a fixed spatial or temporal scales.<br>
Derived from the binomial distribution for an infinite number of binomial distributions and an infinitesimal probability of each occurrence.<br>

PDF for Poisson distribution ($\lambda$ instead of $\mu$ in binomial distribution):
...
```
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.1.2**</span> **Features of Poisson distribution**

- <mark>$\mu=\sigma^2=\lambda$</mark>
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.1.3**</span> **Assumptions**
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.1.4**</span> **Model**
...
## <span style="color:gray; font-family:Microsoft JhengHei;">**15.2**</span> **Workflow**

### <span style="color:gray; font-family:Microsoft JhengHei;">**15.2.1**</span> **Fit model**
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.2.2**</span> **Simplify the model**
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.2.3**</span> **Overdispersion test**

```{r}
library(qcc)
qcc.overdispersion.test(gala$Species, type = "poisson")
```
P-value is smaller than 0.05, it has <mark>overdispersion</mark> (variance is greater than the mean). In this case, the Poisson distribution no longer applies, because it assumes that the variance is equal to the mean. Here we can use `quasipoisson()` function to solve it:
```{r}
fit.gala.reduced.od <-
  glm(Species ~ Endemics + Area + Nearest,
      data = gala,
...
### <span style="color:gray; font-family:Microsoft JhengHei;">**15.2.4**</span> **Result**
